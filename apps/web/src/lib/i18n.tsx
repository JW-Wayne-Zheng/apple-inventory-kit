...
const en = {
  ...
  refresh: "Refresh",
  watchingLive: "Fan mode live · 5-second server pulse",
  ...
  readyToOrder: "Ready to make it yours?",
  checkoutHandoffBody:
    "We’ll hand your exact configuration to Apple. Confirm pickup and payment securely on Apple’s site.",
  selectedConfiguration: "Selected configuration",
  pickupStore: "Preferred pickup store",
  unlocked: "Unlocked",
  finishAtApple: "Finish these steps at Apple",
  checkoutStepOne: "Confirm this configuration and choose Add to Bag.",
  checkoutStepTwo: "Choose pickup, enter your ZIP code, and select this store.",
  checkoutStepThree: "Continue with Apple Account or Guest Checkout and place the order.",
  openExactConfiguration: "Open exact configuration",
  copyOrderDetails: "Copy order details",
  copied: "Copied",
  directionsToStore: "Directions to pickup store",
  checkoutPrivacy:
    "Payment, identity, and order details stay entirely with Apple. Orchard never asks for Apple credentials or card information.",
  closeCheckout: "Close checkout guide",
...
const zh: Record<MessageKey, string> = {
  ...
  refresh: "刷新",
  watchingLive: "果粉模式已开启 · 服务器每 5 秒推送一次",
  ...
  readyToOrder: "准备好把它带回家了吗？",
  checkoutHandoffBody: "我们会把准确配置带到 Apple 页面；取货和付款请在 Apple 官网安全完成。",
  selectedConfiguration: "已选配置",
  pickupStore: "首选取货门店",
  unlocked: "无锁版",
  finishAtApple: "请在 Apple 完成以下步骤",
  checkoutStepOne: "确认配置，然后选择加入购物袋。",
  checkoutStepTwo: "选择到店取货，输入邮政编码，并选择这家门店。",
  checkoutStepThree: "使用 Apple 账户或游客结账，然后提交订单。",
  openExactConfiguration: "打开准确配置",
  copyOrderDetails: "复制下单信息",
  copied: "已复制",
  directionsToStore: "导航到取货门店",
  checkoutPrivacy: "付款、身份和订单信息全部由 Apple 处理。Orchard 不会索取 Apple 凭据或银行卡信息。",
  closeCheckout: "关闭结账指引",
